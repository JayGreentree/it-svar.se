...
$config['install_lock'] = "";
$config['license_number'] = "3029-1541-4580-6597";
$config['debug'] = '1';
$config['cp_url'] = 'http://www.it-svar.se/admin/index.php';
$config['doc_url'] = "http://ellislab.com/expressionengine/user-guide/";
$config['is_system_on'] = "y";
$config['allow_extensions'] = 'y';
$config['site_label'] = 'it-svar.se';
...
|
*/
$config['encryption_key'] = 'oxFy5CzM2VL9LvvZvMZ7bqKfw1wtQWDkg8KuysinhEW9nQNIKjniFImGuBPomkB';
