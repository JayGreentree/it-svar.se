...
class Channel_images_mcp
{
	...
	public function regenerate_sizes()
	{
		...
		ChannelImages.EntryFormURL = "'.str_replace('&amp;', '&', $this->vData['base_cp']).'admin.php?S=0&amp;D=cp&C=content_publish&M=entry_form";
		</script>
		');
	...
	public function mcp_globals()
	{
		...
		$this->EE->cp->add_to_foot('<link type="text/css" rel="stylesheet" href="'.BASE.AMP.'C=css'.AMP.'M=fancybox" />');
